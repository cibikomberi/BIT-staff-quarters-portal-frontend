...
const Innmates = () => {
    ...
    return (
        <div className='main-area' style={{ flexDirection: 'row', position: "relative" }}>
            ...
            {!isAdmin && <div>
                <Link to="add">
                    <md-fab aria-label="Edit" class="fab">
                        <md-icon slot="icon">
                ...
                <Link to="edit">
                    <md-fab aria-label="Edit" class="fab" style={{ right: '110px' }}>
                        <md-icon slot="icon">
                ...
                <Link to="checkout">
                    <md-fab aria-label="Edit" class="fab" style={{ right: '170px', scale: '0.85' }}>
                        <md-icon slot="icon">
...
export const innmatesLoaderUser = async () => {
    ...
    const data = await axios.get(`/innmates/user/${id}`)
        .then((res) => res.data)
    return data;
}
